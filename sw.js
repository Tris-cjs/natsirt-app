...
const CACHE = 'orbeat-mobile-v61'; // v22: OrBeat logo rebrand (orange palette) — bump CACHE whenever a shell asset like logo.png changes, since it has no ?v= cache-buster
const SHELL = [
  './',
  './index.html',
  './style.css?v=264',
